...
if st.session_state.llm_creative:
    ...
    with col_rb:
        ...
        st.markdown(
            """
            <button style='background-color:#eee;color:#888;border:1px solid #ccc;padding:0.5em 1em;border-radius:4px;opacity:0.5;cursor:not-allowed;margin-top:0.5em;margin-bottom:0.5em;' disabled>
                🖼️ Generate Image from Rule-Based Copy (coming soon)
            </button>
            """,
            unsafe_allow_html=True,
        )
    ...
    with col_llm:
        ...
        st.markdown(
            """
            <button style='background-color:#eee;color:#888;border:1px solid #ccc;padding:0.5em 1em;border-radius:4px;opacity:0.5;cursor:not-allowed;margin-top:0.5em;margin-bottom:0.5em;' disabled>
                🖼️ Generate Image from AI Copy (coming soon)
            </button>
            """,
            unsafe_allow_html=True,
        )
